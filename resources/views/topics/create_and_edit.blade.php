        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                	<label for="itle-field">Itle</label>
                	<input class="form-control" type="text" name="itle" id="itle-field" value="{{ old('itle', $topic->itle ) }}" />
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="view_cuont-field">View_cuont</label>
                    <input class="form-control" type="text" name="view_cuont" id="view_cuont-field" value="{{ old('view_cuont', $topic->view_cuont ) }}" />
                </div> 
                <div class="form-group">
